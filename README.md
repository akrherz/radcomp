...
**Instead of using this**, you really should just use [MRMS](https://www.nssl.noaa.gov/projects/mrms/) and download data from their [website](https://mrms.ncep.noaa.gov/data/).  I do provide an archive of selected grib files [on MTArchive](https://mtarchive.geol.iastate.edu/).
